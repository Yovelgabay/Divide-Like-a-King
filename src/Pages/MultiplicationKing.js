...
export default function MultiplicationKing() {
  ...
  if (mode === "practice") {
    return (
      <PracticeMode selectedNumber={selectedNumber} onBack={resetSelection} />
    );
  }

  if (mode === "byNumber") {
    return (
      <NumberSelection onSelect={handleNumberSelect} onBack={resetSelection} />
    );
  }
      ...
      <div className="flex-1 p-4 md:p-8 flex items-center justify-center">
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card
              className="hover:shadow-xl hover:border-amber-400 transition-all cursor-pointer"
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-500 mb-6">
                  תרגול אקראי של כל לוח הכפל. כמה תרגילים תצליח לפתור בדקה?
                </p>
            ...
            <Card
              className="hover:shadow-xl hover:border-orange-400 transition-all cursor-pointer"
              onClick={() => handleModeSelect("byNumber")}
            >
              <CardHeader>
                <div className="flex justify-center mb-4">
              ...
              <CardContent>
                <p className="text-gray-500 mb-6">
                  בחר מספר ותרגל את הכפולות שלו לפי הסדר, מ-1 עד 10.
                </p>
